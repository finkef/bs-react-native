...
function combine(a, b) {
  return UtilsRN.dictFromArray($$Array.append(UtilsRN.dictEntries(a), UtilsRN.dictEntries(b)));
}
...
function style(sarr) {
  return UtilsRN.dictFromList(List.map(encodeStyle, sarr));
}
...
function createTransformObject(perspective, rotate, rotateX, rotateY, rotateZ, scaleX, scaleY, translateX, translateY, skewX, skewY) {
  ...
  var values = List.fold_right((function (x, acc) {
          var match = x[1];
          if (match) {
            var val_ = UtilsRN.dictFromArray(/* array */[/* tuple */[
                    x[0],
                    match[0]
                  ]]);
            return /* :: */[
...
function transform(perspective, rotate, rotateX, rotateY, rotateZ, scaleX, scaleY, translateX, translateY, skewX, skewY, _) {
  return createTransformObject(UtilsRN.option_map((function (prim) {
                    return prim;
                  }), perspective), UtilsRN.option_map((function (prim) {
                    return prim;
                  }), rotate), UtilsRN.option_map((function (prim) {
                    return prim;
                  }), rotateX), UtilsRN.option_map((function (prim) {
                    return prim;
                  }), rotateY), UtilsRN.option_map((function (prim) {
                    return prim;
                  }), rotateZ), UtilsRN.option_map((function (prim) {
                    return prim;
                  }), scaleX), UtilsRN.option_map((function (prim) {
                    return prim;
                  }), scaleY), UtilsRN.option_map((function (prim) {
                    return prim;
                  }), translateX), UtilsRN.option_map((function (prim) {
                    return prim;
                  }), translateY), UtilsRN.option_map((function (prim) {
                    return prim;
                  }), skewX), UtilsRN.option_map((function (prim) {
                    return prim;
                  }), skewY));
}
